...
########################################################################################################################
    ...
    frame2_tab1.grid(row=0,column=2)
...
########################################################################################################################
    ...
    datalog_start_button.grid(row = 0, column = 0)
    ...
    def Exhaust_tab1():
        ...
        damper_label1 = Label(application_window, text = "Damper Position: ",font=("Bold",10))
        damper_label1.grid(row=0, column=0)
        ...
        exhaustfan_label1.grid(row=1,column=0)
        ...
        SHED2_label1 = Label(application_window, text = "SHED2 Exhaust", font=("Bold",10))
        SHED2_label1.grid(row=2,column=0)
        SHED2_valve_position_label1 = Label(application_window, text = "test")
        SHED2_valve_position_label1.grid(row= 2, column=1)
        SHED3_label1 = Label(application_window, text="SHED3 Exhaust", font=("Bold", 10))
        SHED3_label1.grid(row=3, column=0)
